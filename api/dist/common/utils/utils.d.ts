...
export declare const generateRequestNo: (requestId: any) => string;
export declare const generateAdminCode: (adminId: any) => string;
export declare const generateMemberCode: (memberId: any) => string;
